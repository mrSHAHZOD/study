...
@extends('content')
<!-- Header Start -->
    <x-header name1="Maqola" name2="Maqolalar"></x-header>
    <!-- Header End -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    margin-left: auto;
                    margin-right: auto;
                    width: 105%;" src="assets/img/detail.jpg" alt="">
                </div>
                <div class="col-lg-7">
                    ...
                    <p>Invidunt lorem justo sanctus clita. Erat lorem labore ea, justo dolor lorem ipsum ut sed eos,
                        ...
                        dolorInvidunt lorem justo sanctus clita. Erat lorem labore ea, justo dolor lorem ipsum ut sed eos,
                        ipsum et dolor kasd sit ea justo. Erat justo sed sed diam. Ea et erat ut sed diam sea ipsum est
                        dolorInvidunt lorem justo sanctus clita. Erat lorem labore ea, justo dolor lorem ipsum ut sed eos,
                        ipsum et dolor kasd sit ea justo. Erat justo sed sed diam. Ea et erat ut sed diam sea ipsum est
                        dolorInvidunt lorem justo sanctus clita. Erat lorem labore ea, justo dolor lorem ipsum ut sed eos,
